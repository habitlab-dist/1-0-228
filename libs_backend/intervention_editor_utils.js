(function(){
  var memoizeSingleAsync, ref$, get_css_for_package_list, get_requires_for_package_list, get_requires_for_component_list, setkey_dict, swal, $, get_list_requires, get_sweetjs_utils, compile_intervention_code, add_requires_to_intervention_info, out$ = typeof exports != 'undefined' && exports || this;
  ...
  out$.compile_intervention_code = compile_intervention_code = async function(intervention_info){
    var sweetjs_utils, intervention_name, code, compiled_code, err;
    ...
    try {
      ...
      """
      */
      compiled_code = (await new Promise(function(resolve, reject){
        return $.ajax({
          type: 'POST',
          url: 'http://hnudge.dynu.net:47914/',
          data: {
            js: '(async function() {' + code + '})();'
          },
